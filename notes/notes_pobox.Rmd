...
knitr::opts_chunk$set(echo = TRUE,warning = FALSE, message = FALSE, root.dir = '/Users/jck019/Desktop/nsaph/data_team/zip-fips-crosswalk')
library(dplyr)
library(ggplot2)
```
...
hud_xwalk <- read.csv("../data/output/zip2fips_master_xwalk_2010_2023.csv", 
